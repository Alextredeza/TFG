      ...
      <div className="container m-auto p-3">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:mb-5">
          <div className="overflow-hidden">
            <Slider
              images={car?.images ? car?.images.split(",") : [car.img]}
          ...
          <div className="bg-[#43435e] p-3 rounded-md text-white mb-3 lg:mb-0">
            <ul className="">
              ...
              <li className="border-2 border-white/20 p-1">
                ...
                {car?.brand ?? "Sin Espesificación"}
              </li>
              <li className="border-2 border-white/20 p-1">
                <span className="font-bold">Año</span>:{" "}
                {car?.year ?? "Sin Espesificación"}
              </li>
              <li className="border-2 border-white/20 p-1">
              ...
              <li className="border-2 border-white/20 p-1">
                <span className="font-bold">Kilometros</span>:{" "}
                {car?.km ?? "Sin espesificacion"}
              </li>
              <li className="border-2 border-white/20 p-1">
                <span className="font-bold">Potencia</span>:{" "}
                {car?.cv ?? "Sin espesificacion"}
              </li>
              <li className="border-2 border-white/20 p-1">
                <span className="font-bold">Modificaciones</span>:{" "}
                {car?.modif ?? "Sin espesificacion"}
              </li>
            </ul>
          </div>
        </div>
